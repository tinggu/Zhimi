package com.cyou.ui.pickview.view;
...
public class WheelOptions<T,M,F> {
    private View view;
    ...
    private ArrayList<ArrayList<M>> mOptions2Items;
    private ArrayList<ArrayList<ArrayList<F>>> mOptions3Items;
