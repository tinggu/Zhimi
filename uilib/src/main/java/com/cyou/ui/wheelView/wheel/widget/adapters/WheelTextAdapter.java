 ...
 */
package com.cyou.ui.wheelView.wheel.widget.adapters;
 ...
 */
public abstract class WheelTextAdapter implements WheelViewAdapter {
...
//            TextView textvew = (TextView) arrayList.get(index);
//            textvew.setTextSize(minsize);
//            currentIndex = index;
//            textvew = (TextView) arrayList.get(index);
...
//        }
    ...
    public abstract int getIndex(String title);

    public abstract void setCurrent(String title);
